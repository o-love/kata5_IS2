...
public class Main {
    ...
    public void processInput() {
        histogram = FlightHistogramFactory.createFromDepartureTime(flights);
    }
    ...
    public void produceOutput() {
        ...
        SwingUtilities.invokeLater(() -> {
            HistogramDisplay<Integer> histogramDisplay = new HistogramDisplay<>("Hora de salida", histogram);
